...
DEFAULT_PAYLOAD_INDEXES: list[dict[str, str]] = [
    ...
    {"field_name": "chapter_no", "field_schema": "keyword"},
    {"field_name": "section_no", "field_schema": "keyword"},
    {"field_name": "article_no", "field_schema": "keyword"},
    ...
    {"field_name": "clause_id", "field_schema": "keyword"},
    {"field_name": "clause_no", "field_schema": "keyword"},
    {"field_name": "clause_node_id", "field_schema": "keyword"},
    {"field_name": "clause_parent_id", "field_schema": "keyword"},
    {"field_name": "clause_level", "field_schema": "integer"},
    {"field_name": "standard_no", "field_schema": "keyword"},
    {"field_name": "certificate_no", "field_schema": "keyword"},
    {"field_name": "is_mandatory", "field_schema": "bool"},
